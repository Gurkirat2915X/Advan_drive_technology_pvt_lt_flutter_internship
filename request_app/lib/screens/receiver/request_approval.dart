...
class _RequestApprovalScreenState extends ConsumerState<RequestApprovalScreen> {
  ...
  void initState() {
    ...
    itemStates = widget.request.items.asMap().entries.map((entry) {
      ...
      // Create focus node and controller for each item
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Enhanced Request Information Card
            Container(
            ...
            const SizedBox(height: 8),
            // Convert ListView.builder to Column with mapped widgets
            ...itemStates.asMap().entries.map((entry) {
              ...
              final bool isItemEditable = !isItemFulfilled && !isItemReassigned;
                              ...
                              onChanged: isItemEditable ? (newStatus) {
                                setState(() {
                                  ...
                                  if (newStatus != 'reassigned') {
                                    ...
                                    // When reassigned is selected, focus on the note field after a short delay
                ...
                // Add bottom spacing and action buttons
                const SizedBox(height: 32),
                ...
                Container(
                  ...
                  child: Column(
                        ...
                        children: [
                          Expanded(
                            child: ElevatedButton.icon(
                              onPressed: () {
                                // Set all editable items to fulfilled (exclude already fulfilled and reassigned)
                                setState(() {
                    ...
                    label: const Text("Submit Changes", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                  ),
                ),
                    ],
                  ),
