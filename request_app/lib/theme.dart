...
extension ThemeExtension on ThemeData {
  ...
  Color get infoColor =>
      brightness == Brightness.dark ? AppTheme.infoDark : AppTheme.infoLight;

  Color statusColor(String status) =>
      AppTheme.getStatusColor(status, brightness == Brightness.dark);
  Color networkColor(bool isConnected) => AppTheme.getNetworkStatusColor(
    isConnected,
    brightness == Brightness.dark,
  );
}
